...
use AeonDigital\Interfaces\Objects\Standart\Types\Primitive\iPFloatSigned as iPFloatSigned;
...
/**
 * ``Standart Nullable Float`` (flutuante de 32 bits).
 *
 ...
 * @license     MIT
 */
interface iNFloat extends iPFloatSigned, iReadWrite, iNullable
{
}
