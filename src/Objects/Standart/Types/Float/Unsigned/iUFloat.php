...
use AeonDigital\Interfaces\Objects\Standart\Types\Primitive\iPFloatUnsigned as iPFloatUnsigned;
...
/**
 * ``Standart Unsigned Float`` (flutuante de 32 bits).
 *
 ...
 * @license     MIT
 */
interface iUFloat extends iPFloatUnsigned, iReadWrite, iNotNullable
{
}
