...
use AeonDigital\Interfaces\Objects\Standart\Types\Primitive\iPByteSigned as iPByteSigned;
...
/**
 * ``Standart ReadOnly Byte`` (inteiro de 8 bits).
 *
 ...
 * @license     MIT
 */
interface iROByte extends iPByteSigned, iReadOnly, iNotNullable
{
}
