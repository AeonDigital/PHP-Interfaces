...
use AeonDigital\Interfaces\Objects\Standart\Types\Primitive\iPLongSigned as iPLongSigned;
...
/**
 * ``Standart ReadOnly Long`` (inteiro de 64 bits).
 *
 ...
 * @license     MIT
 */
interface iROLong extends iPLongSigned, iReadOnly, iNotNullable
{
}
