...
use AeonDigital\Interfaces\Objects\Standart\Types\Primitive\iPIntSigned as iPIntSigned;
...
/**
 * ``Standart ReadOnly Nullable Int`` (inteiro de 32 bits).
 *
 ...
 * @license     MIT
 */
interface iRONInt extends iPIntSigned, iReadOnly, iNullable
{
}
