 ...
 * Descreve um stream.
 *
 * Equivalente à ``Psr\Http\Message\MessageInterface``, porém, com algumas alterações
...
interface iMessage
{
     ...
     *
     * @return iStream Returns the body as a stream.
     */
     ...
     *
     * The body MUST be a ``iStream`` object.
     *
     * This method MUST be implemented in such a way as to retain the
     * immutability of the message, and MUST return a new instance that has the
     * new body stream.
     *
     * @param iStream $body Body.
     * @return static
